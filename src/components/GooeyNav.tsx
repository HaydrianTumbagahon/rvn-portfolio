...
const GooeyNav = ({
  ...
  const activateItem = (liEl: HTMLLIElement, index: number) => {
  ...
  const handleKeyDown = (e: React.KeyboardEvent<HTMLAnchorElement>, liEl: HTMLLIElement, index: number) => {
    if (e.key === 'Enter' || e.key === ' ') {
      e.preventDefault();
      activateItem(liEl, index);
      liEl.querySelector<HTMLAnchorElement>('a')?.focus();
    }
  };
            ...
            {items.map((item, index) => (
              ...
              >
                <a
                  ...
                  onKeyDown={(e) => {
                    const liEl = e.currentTarget.parentElement as HTMLLIElement;
                    if (liEl) handleKeyDown(e, liEl, index);
                  }}
